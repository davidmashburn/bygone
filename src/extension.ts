...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        ...
        registerCommand('bygone.compareThreeDirectories', () => fileComparator.compareMultipleDirectoriesCommand()),
        registerCommand('bygone.compareMultipleFiles', () => fileComparator.compareMultipleFilesCommand()),
        registerCommand('bygone.compareThreeFiles', () => fileComparator.compareMultipleFilesCommand()),
