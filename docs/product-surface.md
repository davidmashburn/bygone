...
| Search displayed code | Edit → Find or Search Visible Panes | Active or currently displayed Monaco models | Find is read-only; Replace requires the active writable model | Core | find and visible-pane-search tests |
